...
# Решение
- В файле `CustomList.java` содержится код интерфейса с методами `add()`, `get()`, `remove()`
- В файле `CustomArrayList.java` содержится код самого массива, реализующего интерфейс **CustomList**
- В файле `Main.java` представлены примеры использования методов реализованного класса
